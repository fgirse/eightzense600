...
const Home = () => {
 ...
 <section className="col-start-1 col-end-4 row-start-1 row-end-2 md:col-start-1 md:col-end-4  md:row-start-1 md:row-end-2  md:h-auto lg:w-full lg:col-start-1 lg:col-end-13">
      <div className="bg-[url('/images/sideboardobg.png')] bg-contain bg-no-repeat bg-bottom grid gap-y-1 grid-cols-[1fr_1fr_1fr] grid-rows-[34vh_20vh_7vh_10vh] md:grid-cols-[26vw_20vw_20vw_20vw_20vw] md:grid-rows-[24vw_38vh_33vh_20vh]">
...
{banner.button!.enable && (
          <a className="mt-5 bg-amber-500 rounded-xl btn btn-primary text-center w-36 h-10 text-1xl md:text-2xl" href={banner.button!.link}>
           ...
           <Image
              ...
              width="250" 
              alt="Logo"
              className="mt-20 w-20 mx-auto rounded-xl shadow-xl shadow-white/50 col-start-2 cols-end-3 row-start-4 row-end-5">
            ...
            <div className="row items-center justify-between">
              ...
              >
                <ImageFallback
                  ...
                  width={520}
                  alt={feature.title}
                  className="border-8 border-slade-700"
