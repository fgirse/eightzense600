...
const Home = () => {
 ...
 <section className=" col-start-1 col-end-4 row-start-1 row-end-2 md:col-start-1 md:col-end-4  md:row-start-1 md:row-end-2  md:h-auto lg:w-full lg:col-start-1 lg:col-end-13">
      <div className=" grid gap-y-1 grid-cols-[1fr_1fr_1fr] grid-rows-[29vh_34vh_2vh_20vh] place-justify-center md:grid-cols-[26vw_20vw_20vw_20vw_20vw] md:grid-rows-[24vw_38vh_33vh_20vh]">
          <div className="p-3 col-start-1 col-end-4 row-start-1 row-end-2 bg-gradient-to-b from-blue-600/40 to-[#3c3f40] md:bg-gradient-to-b from-blue-600/30 to-[#3c3f40] md:col-start-1 md:col-end-6 md:row-start-1 md:row-end-2">
          ...
          <div className="relative z-10 col-start-2 col-end-4 row-start-1 row-end-2 py-28 leading-3 font-bold text-[.95rem] mt-5 rounded-md w-11/12  font-primary text-stone-400  text-right md:col-start-4 md:col-end-6 md:row-start-1 md:row-end-2 mr:24 md:text-[1.523rem] md:leading-5 lg:text">
                  <p className=" text-gray-300 lg:mt-12"
            ...
            <div className="row items-center justify-between">
              ...
              >
                <ImageFallback
                  ...
                  width={520}
                  alt={feature.title}
                  className="border-8 botder-slate-800 shadow-xl "
                />
              </div>
              <div
